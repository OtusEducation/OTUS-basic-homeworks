...
/**
 * Домашнее задание 17. (Разбор алгоритмов)
 ...
 * На основе разработанного MyLinkedList построить класс MyStack имеющий два метода - push(T data) -
 * помещающий элемент в стек и T pop() - достающий элемент из стека
